			...
			<div class="centro_800">
				<div class="row justify-content-center">
					<div class="col-10 alienado_centro m-b-30">
                        <h1 class='titulo_generico_mini'>AVÍSO DE PRIVACIDAD</h1>
                    </div>
					<div class="col-12">
						<div class="texto_aviso wow zoomIn">
							<p>
								Con fundamento en los artículos 15 y 16 de la Ley Federal de Protección de Datos Personales en Posesión de Particulares hacemos de su conocimiento que CALZADO MINI BURBUJAS SA DE CV, con domicilio en Blvd. La Luz 1728, colonia San Pedro de los Hernandez CP. 37280, León, Guanajuato,  México; es responsable de recabar sus datos personales, del uso que se le dé a los mismos y de su protección, los cuales  utilizará, con la finalidad de mantener contacto con usted, atenderle y llevar a cabo la prestación de servicios o productos relacionados con los objetivos de esta empresa, como son: la fabricación, compra, venta, comisión, consignación, distribución, representación, importación, exportación y maquila de todo tipo de calzado y ropa; en general la industrialización y comercialización en todas sus formas de todo tipo de calzado y ropa, así como de sus ramos anexos y conexos. 
															</p>
															<br>
															<br>
															<p>
								Su información personal será utilizada para las finalidades mencionadas anteriormente,  así como; notificarle sobre nuevos servicios o productos que tengan relación con los ya contratados o adquiridos; comunicarle sobre cambios en los mismos o promociones; elaborar estudios y programas que son necesarios para determinar hábitos de consumo; realizar evaluaciones periódicas de nuestros productos y servicios a efecto de mejorar la calidad de los mismos; evaluar la calidad del servicio o productos que brindamos, realizar transacciones comerciales como son compraventa de productos o insumos afines a la empresa, y dar cumplimiento a las obligaciones comerciales que hemos contraído con usted. Para las finalidades antes mencionadas, requerimos obtener los siguientes datos personales, los cuales únicamente serán ocupados para las finalidades ya descritas: 			
															</p>
								<p></p>
															<br>
															<br>
								...
								•	Identificador de Facebook, Twitter y/o Linkedin o de cualquier red social.<br>
								•	Firma autógrafa.<br>
								...
								<p>
															...
															<br>
								<p>
									Importante: Cualquier modificación a este Aviso de Privacidad podrá consultarlo en  www.miniburbujas.mx 
								</p>
